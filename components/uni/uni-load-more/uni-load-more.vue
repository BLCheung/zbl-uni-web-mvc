<template>
	<view class="uni-load-more" @click="onClick" :style="{'backgroundColor': bgColor}">
		<!-- #ifdef APP-NVUE -->
		...
		<!-- #endif -->
		<text class="uni-load-more__text" :style="{color: color,fontSize: size+'rpx'}">{{ status === 'more' ? contentText.contentdown : status === 'loading' ? contentText.contentrefresh : contentText.contentnomore }}</text>
	</view>
</template>
